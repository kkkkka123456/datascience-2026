...
![](c00-diamonds-assignment_files/figure-gfm/q1-task-1.png)<!-- -->
    ...
    **Observations**:
    -The price of diamonds increases as the carat increases generally.
    -Most of the data points are concentrated between about 0.4 and 2.5 carats. As carat increase, the data point reduced and dispersed.
    -After 1 carat, diamonds appear a large range of prices.
    -Between 1 and 3 carats, most diamonds tend to be closer to the lower end of the carat range, like 1.0, 1.5 and others.
    -More data would help explain the reasons diamond of same carats weight vary on price.
...
- Diamonds with ideal cut tend to have higher prices and fair cut have
  lower.
- Larger carat weight of diamonds have high price even with fair cut.
- Some cut of premium or good can sell a better price than ideal at a
  same carat weight.And there are some diamonds with fair cut have a
  high price. Most data would be explain the reason behind it.
- 
