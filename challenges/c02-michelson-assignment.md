...
**Observations**: - Write your observations here! - The Michelson’s mean
of the velocity are whole numbers, but the mean of velocity from the
data set is not. - Why might your table differ from Michelson’s? -
...
uncertainty) greater or less than the true error? - 51\<151.542,
Michelson’s estimate less than the true error. - Make a quantitative
comparison between Michelson’s uncertainty and his error. -
151.542-51=100.542. Michelson’s error is 100.542 km/s greater than his
uncertainty.
...
**Observations**: Similarities - Both of the datas show similar trend of
line graph - Most of velocity values concentrated between 299900 to
300000 m/s with similar rising time and falling time. - Measure multiple
data of velocity in the same date. Differences - Starting point is
different. - The real data have larger spread of datapoint and simulated
data is closer with the mean value. - The peak of real data is at about
300050 between Jun 09 to Jun 16. For simulated, it’s over 300050 between
Jun 23 to Jun 30. - The lowest point of real data is lower than 299850,
and the simulated is higher.
